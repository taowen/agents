...
export class RPCClientTransport implements Transport {
  private _namespace: DurableObjectNamespace;
  private _name: string;
  private _props?: Record<string, unknown>;
  /** Stored as unknown to avoid deep type instantiation from DurableObjectStub generics */
  ...
  async start(): Promise<void> {
    ...
    // Cast to unknown to avoid deep type instantiation from DurableObjectStub generics
    this._stub = await (getServerByName as Function)(this._namespace, doName, {
      props: this._props
    });

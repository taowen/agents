...
void qwen_f32_matvec_fused_neon(float *y, const float *x, const float *W,
    ...
    for (; o + 1 < out_dim; o += 2) {
        ...
        for (; k + 32 <= in_dim; k += 32) {
            ...
            a0 = vfmaq_f32(a0, vld1q_f32(w0 + k), x0);
            a1 = vfmaq_f32(a1, vld1q_f32(w0 + k + 4), x1);
            a2 = vfmaq_f32(a2, vld1q_f32(w0 + k + 8), x2);
            a3 = vfmaq_f32(a3, vld1q_f32(w0 + k + 12), x3);
            a0 = vfmaq_f32(a0, vld1q_f32(w0 + k + 16), x4);
            a1 = vfmaq_f32(a1, vld1q_f32(w0 + k + 20), x5);
            a2 = vfmaq_f32(a2, vld1q_f32(w0 + k + 24), x6);
            a3 = vfmaq_f32(a3, vld1q_f32(w0 + k + 28), x7);

            b0 = vfmaq_f32(b0, vld1q_f32(w1 + k), x0);
            b1 = vfmaq_f32(b1, vld1q_f32(w1 + k + 4), x1);
            b2 = vfmaq_f32(b2, vld1q_f32(w1 + k + 8), x2);
            b3 = vfmaq_f32(b3, vld1q_f32(w1 + k + 12), x3);
            b0 = vfmaq_f32(b0, vld1q_f32(w1 + k + 16), x4);
            b1 = vfmaq_f32(b1, vld1q_f32(w1 + k + 20), x5);
            b2 = vfmaq_f32(b2, vld1q_f32(w1 + k + 24), x6);
            b3 = vfmaq_f32(b3, vld1q_f32(w1 + k + 28), x7);
        }
        for (; k + 8 <= in_dim; k += 8) {
            float32x4_t x0 = vld1q_f32(x + k);
            float32x4_t x1 = vld1q_f32(x + k + 4);
    ...
    for (; o < out_dim; o++) {
        ...
        float32x4_t acc1 = vdupq_n_f32(0.0f);
        for (; k + 8 <= in_dim; k += 8) {
            acc0 = vfmaq_f32(acc0, vld1q_f32(w_row + k), vld1q_f32(x + k));
            acc1 = vfmaq_f32(acc1, vld1q_f32(w_row + k + 4), vld1q_f32(x + k + 4));
        }
        sum += vaddvq_f32(vaddq_f32(acc0, acc1));
